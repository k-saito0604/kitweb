...
<html lang="ja-jp">
  ...
  <meta property="og:url" content="/search/data.js" />
  ...
  <meta name="twitter:image" content="img/front.png">
...
<div id="top">
  <div class="container">
    <div class="row">
      <div class="col-xs-5">
        <a href="https://www.kitasp.com/"><img src="/img/logo_s.png/" alt=" logo" class=""></a>
      </div>
      <div class="col-xs-7">
        </div>
      </div>
        ...
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand home" href="/">
                    <img src="/img/logo-go-small.png" alt=" logo" class="hidden-xs hidden-sm">
                    <img src="/img/logo-go-small.png" alt=" logo" class="visible-xs visible-sm">
            ...
            <div class="navbar-collapse collapse" id="navigation">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown">
                    ...
                    <a class="dropdown-toggle" href="/go-use/" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="linkmenu">GO-Global活用</span><span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      
                        <li>
                          <a href="/contents/web-separation/">WEB分離</a>
                        </li>
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                          <a href="/representative-greetings/">サポートスケジュール</a>
                        </li>
                      
                        <li>
                          <a href="/philosophy/">サポートの流れ</a>
                        </li>
                      
                        <li>
                          <a href="/history/">サポートポリシー</a>
                        </li>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3 col-sm-3">
            <div class="footer-nav-column">
                ...
                <ul>
                    <li>
                        <a href="/history/">スケジュール</a>
                    </li>        
                <li>
                    <a href="/representative-greetings/">サポートの流れ</a>
                </li>
                <li>
            ...
            <a href="/history/">クッキーポリシー<i class="fas fa-external-link-alt"></i></a>
